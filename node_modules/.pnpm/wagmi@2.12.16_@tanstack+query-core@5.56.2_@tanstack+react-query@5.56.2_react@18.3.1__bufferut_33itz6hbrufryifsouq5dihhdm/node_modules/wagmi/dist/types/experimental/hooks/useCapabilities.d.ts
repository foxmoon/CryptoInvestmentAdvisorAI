...
export type UseCapabilitiesParameters<config extends Config = Config, selectData = GetCapabilitiesData> = Compute<GetCapabilitiesOptions & ConfigParameter<config> & QueryParameter<GetCapabilitiesQueryFnData, GetCapabilitiesErrorType, selectData, GetCapabilitiesQueryKey>>;

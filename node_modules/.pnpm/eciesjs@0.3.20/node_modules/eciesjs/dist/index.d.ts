...
export declare function encrypt(receiverRawPK: string | Buffer, msg: Buffer): Buffer;
export declare function decrypt(receiverRawSK: string | Buffer, msg: Buffer): Buffer;

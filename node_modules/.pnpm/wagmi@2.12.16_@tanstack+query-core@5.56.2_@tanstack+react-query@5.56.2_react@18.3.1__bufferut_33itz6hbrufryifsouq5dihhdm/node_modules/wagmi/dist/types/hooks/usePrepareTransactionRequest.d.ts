...
export declare function usePrepareTransactionRequest<config extends Config = ResolvedRegister['config'], chainId extends config['chains'][number]['id'] | undefined = undefined, request extends viem_PrepareTransactionRequestRequest<SelectChains<config, chainId>[0], SelectChains<config, chainId>[0]> = viem_PrepareTransactionRequestRequest<SelectChains<config, chainId>[0], SelectChains<config, chainId>[0]>, selectData = PrepareTransactionRequestData<config, chainId, request>>(parameters?: UsePrepareTransactionRequestParameters<config, chainId, request, selectData>): UsePrepareTransactionRequestReturnType<config, chainId, request, selectData>;
